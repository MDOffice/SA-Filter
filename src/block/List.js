...
export default class List extends Block {
    ...
    constructor() {
        ...
        this.icon_search = 'icon-search4';
        this.icon_clear = 'icon-cancel-circle2';
    }
    ...
    _init() {
        ...
        $(instance.container)
            .on('click', '.select-list-item, .check-list-item', function (e) {
                e.preventDefault();
        ...
        $(instance.component)
            .on('keyup', '#' + instance.props.search_id, function () {
    ...
    _templateSearch() {
        return '<div class="sa-filter-search">' +
            ...
            '<span class="icon-default ' + this.icon_search + ' noloading"></span>' +
            '</div>';
    }
